...
# 添加额外插件
git clone --depth=1 -b main https://github.com/xptsp/openwrt-twin-bcrypt-js package/openwrt-twin-bcrypt-js
git clone --depth=1 -b main https://github.com/xptsp/luci-app-adguardhome package/luci-app-adguardhome
...
# git clone --depth=1 -b main https://github.com/fw876/helloworld helloworld/luci-app-ssr-plus
...
sed -i "s|firmware_repo.*|firmware_repo 'https://github.com/imaomao/OpenWrt-haiibo'|g" package/luci-app-amlogic/root/etc/config/amlogic
